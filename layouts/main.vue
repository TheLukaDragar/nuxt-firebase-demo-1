<template>
  <v-app id="default">
    ...
    <v-app-bar app dark elevate-on-scroll prominent shrink-on-scroll>
      ...
      <v-toolbar-title>
        <v-img height="46px" contain src="logo_500.png"></v-img>
      </v-toolbar-title>
    ...
    <v-footer app>
      <span
        >&copy; Luka Dragar Ziga Groselj {{ new Date().getFullYear() }}</span
      >
    </v-footer>
  </v-app>
</template>
